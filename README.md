...
All **128 operations** across **9 resource families** are covered:
...
| **SIP** | 47 | SIP Trunking: Domains, CredentialLists, IpAccessControlLists, Domain Auth Mappings (calls + registrations), Inbound Processing Region (routes/v2). |
